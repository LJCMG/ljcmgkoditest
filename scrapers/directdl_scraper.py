...
SEARCH_URL = '/api?key=4B0BB862F24C8A29&quality[]=HDTV&quality[]=DVDRIP&quality[]=720P&quality[]=WEBDL&quality[]=WEBDL1080P&quality[]=1080P-X265&limit=50&keyword='
...
class Scraper(scraper.Scraper):
    ...
    def _http_get(self, url, data=None, cache_limit=8):
        ...
        return super(self.__class__, self)._http_get(url, data=data, require_debrid=False, cache_limit=cache_limit)
